 ...
 */
/* package */ final class MatrixTransformationFactory12 {
  /**
  ...
  public static MatrixTransformation createZoomInTransition() {
    return MatrixTransformationFactory12::calculateZoomInTransitionMatrix;
  }
  ...
  public static MatrixTransformation createDizzyCropEffect() {
    return MatrixTransformationFactory12::calculateDizzyCropMatrix;
  }
  ...
  public static GlMatrixTransformation createSpin3dEffect() {
    return MatrixTransformationFactory12::calculate3dSpinMatrix;
  }
