...
import androidx.media3.demo.transformer.merge_image.Constants.KEY_TRANSITION_VIDEO
...
class ConfigurationActivity : AppCompatActivity() {
    private var onPermissionsGranted: @MonotonicNonNull Runnable? = null
    ...
    private var audioResultLauncher: ActivityResultLauncher<Intent>? =
        null
    private var selectPresetFileButton: @MonotonicNonNull Button? = null
    private var selectLocalFileButton: @MonotonicNonNull Button? = null
    private var selectedFileTextView: @MonotonicNonNull TextView? = null
    private var removeAudioCheckbox: @MonotonicNonNull CheckBox? = null
    private var removeVideoCheckbox: @MonotonicNonNull CheckBox? = null
    private var flattenForSlowMotionCheckbox: @MonotonicNonNull CheckBox? = null
    private var forceAudioTrackCheckbox: @MonotonicNonNull CheckBox? = null
    private var audioMimeSpinner: @MonotonicNonNull Spinner? = null
    private var videoMimeSpinner: @MonotonicNonNull Spinner? = null
    private var resolutionHeightSpinner: @MonotonicNonNull Spinner? = null
    private var scaleSpinner: @MonotonicNonNull Spinner? = null
    private var rotateSpinner: @MonotonicNonNull Spinner? = null
    private var trimCheckBox: @MonotonicNonNull CheckBox? = null
    private var enableFallbackCheckBox: @MonotonicNonNull CheckBox? = null
    private var enableDebugPreviewCheckBox: @MonotonicNonNull CheckBox? = null
    private var abortSlowExportCheckBox: @MonotonicNonNull CheckBox? = null
    private var produceFragmentedMp4CheckBox: @MonotonicNonNull CheckBox? = null
    private var hdrModeSpinner: @MonotonicNonNull Spinner? = null
    private var selectAudioEffectsButton: @MonotonicNonNull Button? = null
    private var selectVideoEffectsButton: @MonotonicNonNull Button? = null
    private var audioEffectsSelections: @MonotonicNonNull BooleanArray? = null
    private var videoEffectsSelections: @MonotonicNonNull BooleanArray? = null
    ...
    private var bitmapOverlayUri: @MonotonicNonNull String? = null
    private var bitmapOverlayAlpha = 0f
    private var textOverlayText: @MonotonicNonNull String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        selectPresetFileButton =
            findViewById<@MonotonicNonNull Button?>(R.id.select_preset_file_button)
        ...
        selectLocalFileButton =
            findViewById<@MonotonicNonNull Button?>(R.id.select_local_file_button)
        selectLocalFileButton!!.setOnClickListener(
            View.OnClickListener { view: View? ->
                selectLocalFile(
                    Assertions.checkNotNull(videoLocalFilePickerLauncher),  /* mimeTypes= */
                    arrayOf("image/*", "video/*", "audio/*")
                )
            })

        selectedFileTextView =
            findViewById<@MonotonicNonNull TextView?>(R.id.selected_file_text_view)
        selectedFileTextView!!.setText(PRESET_FILE_URI_DESCRIPTIONS[inputUriPosition])

        removeAudioCheckbox = findViewById<@MonotonicNonNull CheckBox?>(R.id.remove_audio_checkbox)
        ...
        removeVideoCheckbox = findViewById<@MonotonicNonNull CheckBox?>(R.id.remove_video_checkbox)
        ...
        flattenForSlowMotionCheckbox =
            findViewById<@MonotonicNonNull CheckBox?>(R.id.flatten_for_slow_motion_checkbox)

        forceAudioTrackCheckbox =
            findViewById<@MonotonicNonNull CheckBox?>(R.id.force_audio_track_checkbox)
        ...
        audioMimeSpinner = findViewById<@MonotonicNonNull Spinner?>(R.id.audio_mime_spinner)
        ...
        videoMimeSpinner = findViewById<@MonotonicNonNull Spinner?>(R.id.video_mime_spinner)
        ...
        resolutionHeightSpinner =
            findViewById<@MonotonicNonNull Spinner?>(R.id.resolution_height_spinner)
        ...
        scaleSpinner = findViewById<@MonotonicNonNull Spinner?>(R.id.scale_spinner)
        ...
        rotateSpinner = findViewById<@MonotonicNonNull Spinner?>(R.id.rotate_spinner)
        rotateSpinner!!.setAdapter(rotateAdapter)
        rotateAdapter.addAll(SAME_AS_INPUT_OPTION, "0", "10", "45", "60", "90", "180")

        trimCheckBox = findViewById<@MonotonicNonNull CheckBox?>(R.id.trim_checkbox)
        ...
        enableFallbackCheckBox =
            findViewById<@MonotonicNonNull CheckBox?>(R.id.enable_fallback_checkbox)
        enableDebugPreviewCheckBox =
            findViewById<@MonotonicNonNull CheckBox?>(R.id.enable_debug_preview_checkbox)

        abortSlowExportCheckBox =
            findViewById<@MonotonicNonNull CheckBox?>(R.id.abort_slow_export_checkbox)
        produceFragmentedMp4CheckBox =
            findViewById<@MonotonicNonNull CheckBox?>(R.id.produce_fragmented_mp4_checkbox)

        val hdrModeAdapter =
            ArrayAdapter<String>( /* context= */this, R.layout.spinner_item)
        hdrModeAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        hdrModeSpinner = findViewById<@MonotonicNonNull Spinner?>(R.id.hdr_mode_spinner)
        ...
        selectAudioEffectsButton =
            findViewById<@MonotonicNonNull Button?>(R.id.select_audio_effects_button)
        ...
        selectVideoEffectsButton =
            findViewById<@MonotonicNonNull Button?>(R.id.select_video_effects_button)
...
//            )
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == FILE_PERMISSION_REQUEST_CODE && grantResults.size == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            Assertions.checkNotNull<@MonotonicNonNull Runnable?>(onPermissionsGranted).run()
        } else {
            Toast.makeText(
    ...
    override fun onResume() {
        ...
        if (intentUri != null) {
            Assertions.checkNotNull<@MonotonicNonNull Button?>(
                selectPresetFileButton
            ).isEnabled = false
            Assertions.checkNotNull<@MonotonicNonNull Button?>(
                selectLocalFileButton
            ).isEnabled = false
            Assertions.checkNotNull<@MonotonicNonNull TextView?>(
                selectedFileTextView
...
//        transformerIntent.setData(intentUri)
    ...
    private fun overlayLocalFilePickerLauncherResult(result: ActivityResult) {
        ...
        if (data != null) {
            bitmapOverlayUri = Assertions.checkNotNull(data.data).toString()
        } else {
            Toast.makeText(
                applicationContext,
                getString(R.string.local_file_picker_failed),
    ...
    private fun selectAudioEffects(view: View) {
        AlertDialog.Builder( /* context= */this)
            ...
            .setMultiChoiceItems(
                AUDIO_EFFECTS, Assertions.checkNotNull(audioEffectsSelections)
    ...
    private fun selectVideoEffects(view: View) {
        AlertDialog.Builder( /* context= */this)
            ...
            .setMultiChoiceItems(
                VIDEO_EFFECTS, Assertions.checkNotNull(videoEffectsSelections)
            ) { dialog: DialogInterface, which: Int, isChecked: Boolean ->
    ...
    private fun selectTrimBounds(view: View, isChecked: Boolean) {
        ...
        val trimRangeSlider =
            Assertions.checkNotNull(dialogView.findViewById<RangeSlider>(R.id.trim_bounds_range_slider))
    ...
    private fun controlRgbAdjustmentsScale() {
        ...
        val redScaleSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.rgb_adjustment_red_scale))
        val greenScaleSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.rgb_adjustment_green_scale))
        val blueScaleSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.rgb_adjustment_blue_scale))
        AlertDialog.Builder( /* context= */this)
    ...
    private fun controlContrastSettings() {
        ...
        val contrastSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.contrast_slider))
        AlertDialog.Builder( /* context= */this)
            .setView(dialogView)
            .setPositiveButton(
                android.R.string.ok
            ) { dialogInterface: DialogInterface?, i: Int -> contrastValue = contrastSlider.value }
            .create()
            .show()
    }
    ...
    private fun controlHslAdjustmentSettings() {
        ...
        val hueAdjustmentSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.hsl_adjustments_hue))
        val saturationAdjustmentSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.hsl_adjustments_saturation))
        val lightnessAdjustmentSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.hsl_adjustment_lightness))
        AlertDialog.Builder( /* context= */this)
    ...
    private fun controlPeriodicVignetteSettings() {
        ...
        val centerXSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.periodic_vignette_center_x_slider))
        val centerYSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.periodic_vignette_center_y_slider))
        val radiusRangeSlider =
            Assertions.checkNotNull(dialogView.findViewById<RangeSlider>(R.id.periodic_vignette_radius_range_slider))
    ...
    private fun controlBitmapOverlaySettings() {
        ...
        val uriButton =
            Assertions.checkNotNull(dialogView.findViewById<Button>(R.id.bitmap_overlay_uri))
        uriButton.setOnClickListener(
            (View.OnClickListener { view: View? ->
                selectLocalFile(
                    Assertions.checkNotNull(overlayLocalFilePickerLauncher),  /* mimeTypes= */
                    arrayOf("image/*")
                )
            })
        )
        val alphaSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.bitmap_overlay_alpha_slider))
        AlertDialog.Builder( /* context= */this)
    ...
    private fun controlTextOverlaySettings() {
        ...
        val textEditText =
            Assertions.checkNotNull(dialogView.findViewById<EditText>(R.id.text_overlay_text))
        ...
        val textColorSpinner =
            Assertions.checkNotNull(dialogView.findViewById<Spinner>(R.id.text_overlay_text_color))
        textColorSpinner.adapter = textColorAdapter
        textColorAdapter.addAll(OVERLAY_COLORS.keys)

        val alphaSlider =
            Assertions.checkNotNull(dialogView.findViewById<Slider>(R.id.text_overlay_alpha_slider))
        AlertDialog.Builder( /* context= */this)
            .setTitle(R.string.bitmap_overlay_settings)
            .setView(dialogView)
            .setPositiveButton(
                ...
                textOverlayTextColor = Assertions.checkNotNull(OVERLAY_COLORS[selectedTextColor])
